...
% Codigo da net (http://stackoverflow.com/questions/8519203/prolog-replace-an-element-in-a-list-at-a-specified-index)
...
% Codigo da net (http://stackoverflow.com/questions/27788739/binary-to-decimal-prolog)
binary_number(Bs0, N) :-
        reverse(Bs0, Bs),
